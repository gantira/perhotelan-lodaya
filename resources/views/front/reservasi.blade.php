...
@section('content')
	...
	{{ Form::open(['url'=>'/reservasi/payment', 'method'=>'post', 'class'=>'ui form']) }}
	<div class="ui vertical stripe segment">
	    <div class="ui stackable grid container">
	      <div class="row">
	        <div class="eight wide column">
	          <h3 class="ui header">Reservation Hotel</h3>
	          <small>{{ $temp->checkin->format('d F Y') }} - {{ $temp->checkout->format('d F Y') }}</small>
	          <small>{{ $temp->datediff }} Day(s)</small>
	          
	          		<h4 class="ui dividing header">Guest Information</h4>
							    <div class="field">
									      <label>Name</label>
							      ...
							      <label>Phone No</label>
							    	<div class="two fields">
							    		<div class="four wide column field">
									      <input name="kode_area" type="text" placeholder="+62" required="" value="+62">
							    		</div>
							    		<div class="twelve wide column field">
									      <input name="tlp" type="text" placeholder="" required="">
							    		</div>
							    	</div>
							    	<div class="field">
								    	<label>Address</label>
							    	...
							    	<div class="three fields">
							    		...
							    		<div class="ten wide column field">
									      	<input name="total" id="total" type="text" placeholder="" value="{{ $total }}" required="">
							    		</div>
							    	</div>
								    <div class="field">
								    	<br>
								    	...
								    	{{ Form::hidden('checkin', $temp->checkin) }}
								    	{{ Form::hidden('checkout', $temp->checkout) }}
								    	{{ Form::hidden('day', $temp->datediff) }}

									    {{ Form::submit('Submit Reservation', ['class'=>'ui primary medium button']) }}
								    </div>
				    		</div>
	        ...
	        <div class="six wide right floated column">
	        	<h3>{{ $room->nama }}</h3>
				<img src="{{ asset($room->thumbnail) }}" class="ui huge card image">
				<div class="field">
					<label class="ui label">{!! str_replace(',','',$room->fasilitas) !!} </label>
				</div>
				<div class="field">
					<div class="ui massive form">
					    <div class="ui four wide column field">
							  ...
							  <div class="field">
							    <label>No Room</label>
							    <select class="ui search dropdown" name="room_detail_id" required="">
							  ...
							  <div class="field">
							    ...
							    <select name="extrabed" class="ui dropdown" id="extrabed" onchange="hitung(this.value)">
	      ...
	      <div class="row">
	        <div class="center aligned column">
	          	{{-- <a href="{{ url('/room')kelas-> }}" class="ui huge button"></a> --}}
