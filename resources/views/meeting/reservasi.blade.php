...
@section('content')
	...
	{{ Form::open(['url'=>'/reservasi/meeting/payment', 'method'=>'post', 'class'=>'ui form']) }}
	<div class="ui vertical stripe segment">
	    <div class="ui stackable grid container">
	      <div class="row">
	        <div class="eight wide column">
	          <h3 class="ui header">Reservation Meeting Room</h3>
	          <small>Waktu Pemesanan {{ $temp->checkin->format('d F Y') }} Pukul {{ $temp['jam'] }}</small>
							      ...
							      <label>Phone No</label>
							    	...
							    	<div class="three fields">
							    		...
							    		<div class="ten wide column field">
									      	<input name="total" id="total" type="text" placeholder="" value="{{ $meeting->harga }}" required="">
							    		</div>
							    	</div>
								    <div class="field">
								    	<br>
	        ...
	        <div class="six wide right floated column">
	        		...
	        		<div class="ui two cards">
						<div class="card">
						  <div class="content">
						    <div class="header">{{ $meeting->nama}}</div>
						    <h4 class="ui sub header">Rp {{ $meeting->harga }}</h4>
						    <div class="description">
						      <p>{!! $meeting->deskripsi !!}</p>
						    </div>
						  </div>
						</div>
					</div>
	        ...
	        {{-- 	<h3>{{ $meeting->nama }}</h3>
				<div class="field">
					<label class="ui label">{!! str_replace(',','',$meeting->deskripsi) !!} </label>
				</div> --}}
	        </div>
	      ...
	      <div class="row">
	        <div class="center aligned column">
	          	{{-- <a href="{{ url('/meeting')kelas-> }}" class="ui huge button"></a> --}}
